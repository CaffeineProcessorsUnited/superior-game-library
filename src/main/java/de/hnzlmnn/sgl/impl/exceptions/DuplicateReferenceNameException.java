 ...
 */
public class DuplicateReferenceNameException extends SGLException {
    public DuplicateReferenceNameException(String name) {
        super("A reference " + name + " already exists!");
    }
}