 ...
 */
public class ApplicationConfigurationNotProvidedException extends SGLException {
    public ApplicationConfigurationNotProvidedException() {
        super("You didn't provide a configuration for your application!");
    }
}